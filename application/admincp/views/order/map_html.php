    ...
    <?php if ($map['posterStyle'] == 'white'): ?>
        <style> /**White Text CSS**/
            ...
            .map-location .white-text-div {
                background: #ffffff;
                width:100%;
                margin-top: <?php echo ($map['height'] - 470 - 300); ?>px
            }
            .map-location .city { 
                margin-top:0px; 
                color: #333;
            ...
            .map-location .tag-line {font-family: "Oswald",sans-serif;font-size: 120px;font-weight: 500;line-height: 20px;margin-bottom: 0;margin-top: 0;padding: 2px 10px 0px;text-transform: uppercase;}
            .map-location .des-address {margin-top:10px;color: #7c7c7c;font-family: "Oswald",sans-serif;font-size: 100px;margin-bottom: 4px;padding: 2px 10px 0px;}
        </style>    
    <?php endif; ?>
    <?php if ($map['posterStyle'] == 'modern'): ?>
        <style>  /**Modern CSS**/
            ...
            .map-location-modern .white-text-div {
                ...
                width: 100%;
                text-align:center;
                margin-top: <?php echo ($map['height'] - 470 - 765); ?>px
            }
    ...
    <?php if ($map['posterStyle'] == 'stricts'): ?>
        <style>
            .map-location-stricts{
                ...
                bottom: 0px;
                width:<?php echo $map['width'] - 20 ?>px; 
                height:<?php echo $map['height'] - 470; ?>px 
            }
            .map-location-stricts .white-text-div {
                ...
                width:1600px;
                text-align:center;
                margin-top: <?php echo ($map['height'] - 470 - 455); ?>px
            }
