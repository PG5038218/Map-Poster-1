<div class="panelt panel-primary">
    <div class="panel-heading">
        ...
        <h3 class="panel-title">New Style</h3>
    </div>
    <?php echo form_open('style/add',array('id'=>'frmAdd','enctype'=>'multipart/form-data')); ?>
    <div class="panel-body">
        <img id="imgLogo" src="../img/circle-map1.png" height="60" width="60" class="pull-right" />
        <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="api_path" id="api_path" value="" />
            </div>
        </div>
        <div class="col-md-12">
