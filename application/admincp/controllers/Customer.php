...
class Poster extends MY_Controller {
    ...
    public function add(){
        ...
        if($this->input->method()=='post'){
            ...
            $poster=array(
                ...
                'poster_height'=>$this->input->post('height'),
                'poster_width'=>$this->input->post('width'),
    ...
    public function dataTable(){
        $columns=array('poster_name','','poster_price','status','datetime');
        $request=$this->input->get();
        $getfiled="poster_id as id,poster_name as name,poster_height as height,poster_width as width,poster_price as price,status,created_datetime as datetime";
        echo $this->common->getDataTableSource('poster',$columns,array(),$getfiled,$request);
    }
}
