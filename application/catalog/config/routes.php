...
$route['404_override'] = '/404/index.html';
$route['translate_uri_dashes'] = FALSE;
...
$route['showcase']='page/showcase';
$route['contactus'] = 'page/contactus';
$route['ternsandconditions']='page/ternsandconditions';
$route['privacypolicy']='page/privacypolicy';
$route['faq']='page/faq';
$route['subscribe'] = 'page/subscribe';
$route['thankyou'] = 'page/thankyou';

$route['editorv2'] = 'editor/v2';
$route['editor-v2/(:any)'] = 'editor/$1';
$route['editor/v2/(:any)'] = 'editor/$1';