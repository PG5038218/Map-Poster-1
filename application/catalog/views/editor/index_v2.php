...
<div class="loader"><table><tbody><th><p>Por favor espera... Estamos procesando tu pedido</p><i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i></table></tbody></th></div>
    <div class="container cstm-container">
        ...
        <div class="setup-content" id="step-1">
            <div class="col-md-6 col-xs-12 padding-0 cstm-tab">
                <div class="bg_white with-tx">
                    <p class="form-title">Encuentra tu ciudad favorita</p>
                    <form class="location-form">
                        <div class="form-group col-md-10 padding-0">
                            <div class="inner-addon right-addon"> <i class="glyphicon glyphicon-map-marker"></i>
                                <input type="text" class="form-control" placeholder="Ciudad" name="address" id="address" autocomplete="off"  spellcheck="false" />
                            </div>
                        </div>
                        <div class="form-group col-md-10 padding-0">
                    ...
                    <p class="perfectionist"><b>¿Eres perfeccionista? También lo somos nosotros! </b>Puedes modificar el zoom y la posicíon en el mapa para perfeccionar el posicionamiento de tu ciudad favorita. También puedes modificar los campos de texto.</p>
                </div>
                <div class="bg-white-new padding-right-0"> <img src="<?php echo base_url(); ?>img/caret.png" class="img-responsive shadow" alt="" title="" width="11" height="10" />
                    ...
                    <button id="activate-step-2" class="btn btn-primary btn-lg next">Próximo paso</button>
                </div>
            </div>
        </div>
        <div class="setup-content" id="step-2">
            <div class="col-md-6 padding-0 cstm-tab">
                <div class="bg_white">
                    <p class="form-title">Excelente! Ahora añade un estilo para tu mapa</p>
                    <div class="col-xs-12 padding-0 hide-btn" id="hide-btn">
                        <div class="style-btm">
                            <p class="poster-style">Estilos del Poster</p>
                            <?php foreach($posterstyles as $style): ?>
                            <button value="<?php echo $style['style_value'] ?>" class="btn btn-with-text <?php if($style['isdefault']){echo "active";} ?>" id="<?php echo $style['style_name'] ?>" ><?php echo $style['style_value'] ?></button>
                            <?php endforeach; ?>
                        ...
                        <div class="clearfix"></div>
                        <div class="style-btm">
                            <p class="poster-style">Opciones de mapas</p>
                            <div class="map-img"> 
                                <?php foreach($styles as $style): ?>
                                <button value="<?php echo $style['style_path'] ?>" 
                                        data-api="<?php echo $style['static_api_path'] ?>" 
                                        class="map-img-circle <?php if($style['isdefault']){echo "active";} ?>" >
                ...
                <div class="bg-white-new padding-right-0"><img src="<?php echo base_url(); ?>img/caret.png" class="img-responsive shadow" alt="" title="" width="11" height="10" />
                    ...
                    <div class="clearfix"></div>
                    <img class="img-responsive shadow" src="<?php echo base_url(); ?>img/caret.png" alt="" title="" width="11" height="10" />
                    <button id="activate-step-3" class="btn btn-primary btn-lg next">Próximo paso</button>
                </div>
            </div>
        </div>
        <div class="setup-content" id="step-3">
            <div class="col-md-6 padding-0 cstm-tab">
                <div class="bg_white with-tx">
                    <p class="form-title">Otras Opciones</p>
                    <div class="col-xs-12 padding-0" id="hide-layout-btn">
                        <div class="style-btm">
                            <p class="poster-style">Orientación</p>
                        ...
                        <div class="clearfix"></div>
                        <div class="style-btm">
                            <p class="poster-style">Acabado</p>
                            <button class="btn btn-with-text-finish active" id="paper" value="Sin Borde">Sin Borde</button>
                            <button class="btn btn-with-text-finish" id="strict" value="Con Borde">Con Borde</button>
                            <!--<button class="btn btn-with-text-finish" id="framed">Framed</button>-->

                        </div>
                        <div class="clearfix"></div>
                        <div class="style-btm">
                            <p class="poster-style">Tamaño del Poster</p>
                            ...
                            <button data-height="<?php echo $poster['poster_height']; ?>" 
                                    ...
                                    class="btn btn-with-text-size <?php if($poster['isdefault']){echo "active";} ?>" 
                        ...
                        <p class="perfectionist"><b>¿Eres perfeccionista? También lo somos nosotros! </b>Puedes modificar el zoom y la posicíon en el mapa para perfeccionar el posicionamiento de tu ciudad favorita.</p>
                    </div>
                </div>
                <div class="bg-white-new padding-right-0"> <img src="<?php echo base_url(); ?>img/caret.png" class="img-responsive shadow" alt="" title="" width="11" height="10" />
                    <div class="gray-inner">
                    ...
                    <div class="clearfix"></div>
                    <img class="img-responsive shadow" src="<?php echo base_url(); ?>img/caret.png" alt="" title="" width="11" height="10" />
                    <button id="activate-step-4" class="btn btn-primary btn-lg next">Próximo paso</button>
                </div>
            </div>
        </div>
        <div class="setup-content" id="step-4">
            <div class="col-md-12 padding-0">
                <div class="col-md-5">
                    <div class="bg_white">
                        <ul class="shipping">
                            ...
                            <li id="hide">
                                <div class="add">
                                    <button class="add-map" title="Añadir otro mapa" id="add_map"><i class="fa fa-plus-circle"></i>Añadir otro mapa</button>
                                    <button class="add-coupon" title="Ingresar cupón de descuento" id="coupon-code">Ingresar cupón de descuento</button>
                                </div>
                            </li>
                                ...
                                <form class="form-horizontal cs-form-horizontal" target="_balnk" id="frmCouponCode">
                                    <div class="form-group">
                                        <div class="col-xs-12 pull-left padding-0">
                                            ...
                                            <div class="vrify">
                                                <button id="verifyCode" type="button" class="btn enter-code" disabled="">Verificar</button>
                ...
                <div id="shippingTab" class="col-md-7">
                    ...
                    <div class="bg_white top-new">
                        <p class="form-title">Datos de envio</p>
                            ...
                            <div class="form-group col-md-6 col-xs-12 padding-0">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="lname" id="lname" placeholder="Apellidos">
                                </div>
                            </div>
							<div class="clearfix"></div>
                            <div class="form-group col-md-6 col-xs-12 padding-0">
                                <label class="control-label col-md-12">Dirección - Calle</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="address_line" id="address_line" placeholder="Dirección">
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-xs-12 padding-0">
                                <label class="control-label col-md-12">Otros datos de dirección</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="address_line2" id="address_line2" placeholder="Continuación dirección">
                                </div>
                            </div>
							<div class="clearfix"></div>
                            <div class="form-group col-md-6 col-xs-12 padding-0">
                                <label class="control-label col-md-12">Ciudad</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="city" id="city" placeholder="Ciudad">
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-xs-12 padding-0">
                                <label class="control-label col-md-12">Provincia</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="state" id="state" placeholder="Provincia">
                                </div>
                            </div>
							<div class="clearfix"></div>
                            <div class="form-group col-md-6 col-xs-12 padding-0">
                                <label class="control-label col-md-12">País</label>
                                <div class="col-sm-12">
                                    <select class="selectpicker" data-live-search="true" name="country" id="country" title="Selecciona tu país">
                            ...
                            <div class="form-group col-md-6 col-xs-12 padding-0">
                                <label class="control-label col-md-12">Código Postal</label>
                                <div class="col-sm-12">
			...
			<div class="col-sm-8">
				<p class="form-title">Datos de Pago<br>
                            <span>Todas las transacciones son seguras y encriptadas. No guardamos nunca los datos de tu tarjeta .</span></p>
			</div>
                        <div class="col-sm-4">
				<img src="<?php echo base_url('img/stripe-secure-300x118.png'); ?>" class="img img-responsive"  />		
                            ...
                            <div id="credit-card" class="desc">
                                <div class="form-group col-md-12 col-xs-12 padding-0">
                                    <label class="control-label col-md-12">Nº tarjeta de crédito</label>
                                    <div class="col-sm-12">
									<span class="txbox-icon"><i type="button" class="fa fa-credit-card"></i></span>
                                        <input type="text" class="form-control" name="cardnumber" id="cardnumber" placeholder="Nº de tarjeta de Crédito"  maxlength="20" autocomplete="off">
                                ...
                                <div class="form-group col-md-4 col-xs-12 padding-0">
                                    <label class="control-label col-md-12">Fecha caducidad. MM/AA</label>
                                ...
                                <div class="form-group col-md-8 col-xs-12 padding-0">
                                    <label class="control-label col-md-12">Código CVV2</label>
                                    <div class="col-sm-4 col-xs-9">
                                        <input type="password" class="form-control" name="cardcvc" id="cardcvc" placeholder="Código CVV2" maxlength="4" autocomplete="off">
                                    ...
                                    <div class="col-sm-12 pull-left">
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                He leido y Acepto <a target="_blank" href="<?php echo base_url('ternsandconditions'); ?>">los Términos & Condiciones</a> </label>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="bg-white-new padding-right-0"> 
                        <div class="clearfix"></div>
                        <button class="btn btn-primary btn-lg next" id="activate-step-5">Completar Pedido</button>
                    </div>
                </div>
